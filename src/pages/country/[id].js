...
const Country = ({ country }) => {
    return (
        <div className="bg-primary pv-2 lg-pv-2 ph-2">
            <Head>
                <title>{country[0].name.common} {country[0].flag}</title>
                <meta name="description" content="Generated by create next app" />
                <link rel="icon" href="/images/logo.png" />
            </Head>
            <div className="grid-2x2 lg-grid-2x1">
                <div className="pos-1_1 bg-secondary elevate-1 round-1 lg-mh-2 p-2 col-span-2 lg-pos-1_1 md-h-auto">
                    <div className="w-60p m-auto pt-2"><img src={country[0].flags.png} alt={country[0].name.common} className="w-100p round-3"></img></div>
                ...
                <div className="lg-pos-2_1 bg-secondary elevate-1 round-1 mr-1 p-2 md-ph-4 c-semantic-primary col-span-2 pos-1_2 mt-2 lg-mt-0">
                    ...
                    <div className="mt-5 pt-3">
                        ...
                        <div className="grid-3x1 lg-grid-2x1 bb-solid bl-solid br-solid b-main-cultured-white-1 ph-2 pv-2">
                            <div className="pos-1_1 label f-2 fw-500 c-neutral-2 lg-col-span-2 lg-pos-1_1 ">Google Maps</div>
                            <div className="pos-2_1 col-span-2 value f-2 lg-f-1 fw-600 t-right lg-col-span-2 lg-pos-1_2">
